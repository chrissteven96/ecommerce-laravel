      ...
      <div class="hero-container">
        <div class="hero-content">
          <div class="content-wrapper" data-aos="fade-up" data-aos-delay="100">
            <h1 class="hero-title">Descubre productos increibles</h1>
            <p class="hero-description">Explora nuestra cuidada colección de artículos premium diseñados para mejorar tu estilo de vida. Desde moda hasta tecnología, encuentra todo lo que necesitas con ofertas exclusivas y envío rápido..</p>
            <div class="hero-actions" data-aos="fade-up" data-aos-delay="200">
              <a href="#products" class="btn-primary">Comienza Ahora</a>
              <a href="#categories" class="btn-secondary">Explorar productos</a>
            </div>
