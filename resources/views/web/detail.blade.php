            ...
            <div class="product-gallery">
              <div class="main-showcase">
                <div class="image-zoom-container">
                    @php
                        $imagenPrincipal = $producto->imagenes->first()?->imagen;
                    @endphp
                  <img src="{{ $imagenPrincipal ? asset('storage/' . $imagenPrincipal) : asset('default/no_photo.png') }}" alt="Product Main" class="img-fluid main-product-image drift-zoom" id="main-product-image" data-zoom="{{ $imagenPrincipal ? asset('storage/' . $imagenPrincipal) : asset('default/no_photo.png') }}">
              ...
              <div class="thumbnail-grid">
                @foreach ($producto->imagenes as $imagen)
                    <div class="thumbnail-wrapper thumbnail-item active" data-image="{{ asset('storage/' . $imagen->imagen) }}">
                        <img src="{{ asset('storage/' . $imagen->imagen) }}" alt="vista {{ $loop->iteration }}" class="img-fluid">
                    </div>
                @endforeach
          ...
          <div class="col-lg-5" data-aos="fade-left" data-aos-delay="200">
            <div class="product-details">
              ...
              <div class="availability-status">
                ...
                <div class="quantity-left">Solo quedan {{ $producto->stock }} artículos </div>
              </div>
              ...
              <div class="benefits-list">
                ...
                {{-- <div class="benefit-item">
                  ...
                  <span>45-day devolución sin problemas</span>
                </div> --}}
                <div class="benefit-item">
