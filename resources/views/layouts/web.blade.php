...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('storage/' . $ajuste->logo) ?? 'assets/img/favicon.png' }}" rel="icon">
  <link href="{{ asset('storage/' . $ajuste->logo) ?? 'assets/img/favicon.png' }}" rel="apple-touch-icon">
        ...
        <div class="row align-items-center">
          <div class="col-lg-4 d-none d-lg-flex">
            <div class="top-bar-item">
              ...
              <a href="tel:+1234567890">{{ $ajuste->telefono ?? '+1234567890' }}</a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-12 text-center">
            <div class="announcement-slider swiper init-swiper">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">🚚 Envio gratis en compras superiores a $50</div>
            ...
            <div class="dropdown account-dropdown">
              ...
              <div class="dropdown-menu">
                <div class="dropdown-header">
                  <h6>Bienvenido a <span class="sitename">{{ $ajuste->nombre ?? 'Tienda' }}</span></h6>
                ...
                <div class="dropdown-footer">
                  ...
                  @else
                    ...
                    <a href="{{ url('web/registro') }}" class="btn btn-outline-primary w-100">Registrarse</a>
                  @endif
                </div>
              </div>
            </div>
