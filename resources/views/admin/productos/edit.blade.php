...
@section('content')
    <div class="container-fluid">
        <h1 class="h3 mb-4">Actualizar Producto - {{ $producto->nombre }}</h1>
        <hr>
        ...
        <div class="card shadow mb-4">
            ...
            <hr>
            <div class="card-body">
                <form action=" {{ url('/admin/producto/' . $producto->id) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="categoria_id" id="categoria_id" class="form-control"  required>
                                    <option value="{{ $producto->categoria_id }}">Selecciona una categoria</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="codigo" id="codigo" class="form-control" placeholder="Código del producto" value="{{ old('codigo', $producto->codigo) }}" required>
                                </div>
                                @error('codigo')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="descripcion_corta" id="descripcion_corta" class="form-control" rows="3">{{ $producto->descripcion_corta }}</textarea>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="" style="width: 100%;">
                                    <textarea name="descripcion_larga" id="descripcion_larga" class="form-control ckeditor" placeholder="Descripción larga" rows="3" required>{{ $producto->descripcion_larga }}</textarea>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="slug" id="slug" class="form-control" value="{{ $producto->slug }}" readonly required>
